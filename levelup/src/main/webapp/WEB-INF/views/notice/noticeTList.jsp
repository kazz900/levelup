...
<fieldset>
	...
	<input type="submit" value="검색">
									...
									<ul class="message-list">
									    <c:forEach items="${requestScope.tlist}" var="n" varStatus="loop">
									        <li>
								...
								<div class="row">
									...
									<div class="col-5">
										<div class="btn-group float-end">
											<c:if test="${loginEmployee.rankId eq 'jman' || loginEmployee.rankId eq 'sman' || loginEmployee.rankId eq 'jdirec' || loginEmployee.rankId eq 'direc' || loginEmployee.rankId eq 'ceo'}">
