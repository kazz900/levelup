...
<form action="rePwd.do" method="post">
    <div class="mb-3">
        ...
        <input type="password" class="form-control userpwd" name="rePwd" id="rePwd" placeholder="Enter PassWord">
        <br>
        <label for="rePwd" class="form-label">비밀번호 재입력 : </label>
        <input type="password" class="form-control userpwd2" name="rePwd2" id="rePwd2" placeholder="ReEnter">
        <br>
