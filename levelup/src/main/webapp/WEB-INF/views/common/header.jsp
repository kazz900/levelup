								...
								<div class="col-md-4">
									...
									<ul class="list-unstyled megamenu-list">
										<li><a href="javascript:void(0);" key="t-light-sidebar">Light
												Sidebar</a></li>
										<li><a href="javascript:void(0);" key="t-compact-sidebar">Compact
												Sidebar</a></li>
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block">
				<button type="button" class="btn header-item waves-effect"
					...
					aria-expanded="false">
					<img id="header-lang-img" src="resources/images/flags/us.jpg"
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a href="javascript:void(0);"
						...
						src="resources/images/flags/us.jpg" alt="user-image" class="me-1"
						height="12"> <span class="align-middle">English</span>
					</a>
					<!-- item-->
					<a href="javascript:void(0);"
						class="dropdown-item notify-item language" data-lang="sp"> <img
						src="resources/images/flags/spain.jpg" alt="user-image"
					...
					<a href="javascript:void(0);"
						...
						src="resources/images/flags/germany.jpg" alt="user-image"
					...
					<a href="javascript:void(0);"
						...
						src="resources/images/flags/italy.jpg" alt="user-image"
					...
					<a href="javascript:void(0);"
						...
						src="resources/images/flags/russia.jpg" alt="user-image"
			...
			<div class="dropdown d-inline-block">
				<button type="button" class="btn header-item noti-icon waves-effect"
					...
					<i class="bx bx-bell bx-tada"></i> <span
						class="badge bg-danger rounded-pill">4</span>
				</button>
							...
							<div class="d-flex">
								...
								<div class="flex-grow-1">
									...
									<div class="font-size-12 text-muted">
										...
										<p class="mb-0">
											<i class="mdi mdi-clock-outline"></i> <span key="t-hours-ago">1
												hours ago</span>
										</p>
									</div>
								</div>
			...
			<div class="dropdown d-inline-block">
				...
				<div class="dropdown-menu dropdown-menu-end">
					...
					<a class="dropdown-item" href="#"><i
						...
						key="t-settings">Settings</span></a> <a class="dropdown-item" href="#"><i
...
<!-- 	<div th:fragment="header-horizontal" th:remove="tag"> -->
        ...
        $.ajax({
            ...
            success: function(dataObj) {
                ...
                for (var i in dataObj.sclist) {
                    ...
                    output += '<a href="javascript: void(0);" class="text-reset notification-item"><div class="d-flex"><div class="avatar-xs me-3"><span class="avatar-title bg-primary rounded-circle font-size-16"><i class="fas fa-calendar-check"></i></span></div><div class="flex-grow-1"><h6 class="mb-1" key="t-your-order"></h6><div class="font-size-12 text-muted"><p class="mb-1" key="t-grammer">'
